...
var ZeroClipboard = {
  ...
  moviePath: contextPath + '/js/lib/zclip/ZeroClipboard.swf', // URL to movie
...
ZeroClipboard.Client.prototype = {
  ...
  glue: function(elem, appendElem, stylesToAdd) {
    ...
    this.div.className = 'ZeroClipboardMovie';

    if (ZeroClipboard.title && ZeroClipboard.title.length > 0) {
      this.div.setAttribute('title', ZeroClipboard.title);
    }
